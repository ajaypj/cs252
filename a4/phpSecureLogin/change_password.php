 ...
 */
include_once 'includes/change_password.inc.php';
...
<html>
    ...
    <body>
        ...
        <h1>Change password by either providing correct security answer or old password</h1>
        <?php
        if (!empty($error_msg)) {
            echo $error_msg;
        }
        ...
        <form method="post" name="change_password_form" id="change_password_form" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>">
            <!--Username: <input type='text' name='username' id='username' /><br>-->
            Email: <input type="text" name="email" id="email" /><br>
            Old Password: <input type="password"
                             name="oldpassword" 
                             id="oldpassword"/><br>
            Enter either of 1st pet, 1st school, 1st bestfriend:
            ...
            <input type="button" 
                   value="Change" 
                   onclick="return change_password(this.form,
	...
	<script type = "text/javascript">
		var pass = document.getElementById("change_password_form").elements["password"];
        pass.addEventListener('keyup', function(){
            checkPassword(pass.value);
        });
        function checkPassword(password){
            // var strengthBar = document.getElementById("change_password_form").elements["strength"];
